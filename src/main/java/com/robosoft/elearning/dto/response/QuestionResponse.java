...
public class QuestionResponse {
    ...
    public QuestionResponse(Long id, String questionStatement, List<String> options, String questionImageUrl, Integer previouslySelectedOption, Integer currentQuestionIndex, Integer totalQuestions, Integer lessonIndex, String lessonName, Integer chapterIndex) {
        this.id = id;
